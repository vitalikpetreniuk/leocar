...
<section id="leo-testdrive" class="leo-testdrive pt-28 500:mt-[10vw] 1100:mt-0 1100:pt-20">
    <div class="container">
        <div class="px-8 pt-1.5 pb-8 rounded-2xl 1024:p-0 1024:pt-14 1024:pb-5 1024:flex 1024:flex-row-reverse 1024:items-center 1100:pt-0">
            <?php echo wp_get_attachment_image(get_field('image'), 'full', false, ['class' => "block relative -mt-24 left-[-30px] w-[calc(100%+60px)] max-w-none 500:-mt-[30vw] pointer-events-none 1024:left-0 1024:w-7/12 1024:-mt-44 1100:-mt-36"]); ?>
